...
const baseImports = require('./imports');
const baseVariables = require('./variables');
  ...
  Object.assign(config, {
    overrides: [
      ...
      // linted without specifying it on the user-end
      {
        ...
        /**
         * Slow and cannot disable for markdown files
        ...
        rules: {
          ...
          'import/no-extraneous-dependencies': [
            'error',
            {
              ...
              devDependencies: [...noExtraneousDependenciesConfig.devDependencies.map((pattern) => pattern.replace('.js', '.{js,ts}'))]
            }
          ],
